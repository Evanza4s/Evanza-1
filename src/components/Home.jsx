...
const Home = () => {
  return (
    ...
    I'm Student of Vocational 1 Cimahi High School, Network Engineer Major.
    I like coding a website with technologies like React, Tailwind, Next JS, and Laravel.
    </p>
    ...
    <div>
    <img src={Sinestrea} alt="my-profile" className=' rounded-2xl mx-auto w-2/3 md:w-full' />
    </div>
    </div>
    </div>
  )
